...
<body style="background: url(&quot;assets/img/mountain_bg.jpg&quot;);">
    <section class="login-dark" style="background: url(&quot;assets/img/mountain_bg.jpg&quot;) center;">
        <form method="post" style="background: var(--gray-dark);">
            ...
            <div class="form-group"><button class="btn btn-primary btn-block" data-bss-hover-animate="rubberBand" type="submit" style="color: rgb(0,0,0);background: rgb(255,255,255);width: 150;">Crear reporte</button></div>
        </form>
    </section>
